...
||대회명|주최기관|역할|상격|
|-------|-----|-----|-----|-----|
|2026-03   |Practical Fuzzy PSI for High-Dimensional Vectors||공동 1저자|논문 작성 중...|
|2026-03   |Sparse Meta-BTS: Bootstrapping for Sparsely Packed Ciphertext||제1저자|논문 작성 중...|
|2025-08   |Bootstrapping for approximate homomorphic encryption based on Microsoft SEAL|||SW 국가 R&D 성과물 등록 및 특허 등록|
|2025-05   |Secure Pattern Matching on Non-Binary Data using Homomorphic Encryption||제1저자|정보보호학회|
|2025-03   |Secure Pattern Matching on Non-Binary Data using Homomorphic Encryption||제1저자|대한수학회|
|2024-06   |양자 내성 암호인 동형암호를 활용한 만성 신장 질환 검진 프로그램||연구 및 개발|SW 국가 R&D 성과물 등록 및 특허 등록|
